						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-12">
								<div class="block d-flex">
								    <div class="row">
								    <div class="iwant col-md-2 d-none">
								    ...
								    <div class="col-md-2">
								        ...
								        <select name="locality" class="form-control" required>
                                            ...
                                            <option value="">TDI</option>
                                            <option value="">Sector-115</option>
                                            <option value="">Gillco Valley</option>
                                            <option value="">Landra Road</option>
                                            <option value="">Sohana</option>
                    					</select>
								    </div>  
								    <div class="col-md-4">
								        <label>Budget</label>  
								        <div class="row">
								        <div class="col-md-6">
									<input type="number" min="1000000" max="4000000" class="form-control mb-2 mr-sm-2 mb-sm-0" name="budgetmin" id="budget" value="<?php print_r($city);?>" placeholder="Min (Lacs)">
								    
								    </div>
								        <div class="col-md-6">
									<input type="number" min="1000000" max="4000000"  class="form-control mb-2 mr-sm-2 mb-sm-0" name="budgetmax" id="budget" value="<?php print_r($city);?>" placeholder="Max (Lacs)">
								    </div>								    
								    </div>
								    </div>  
								    <div class="col-md-2">
