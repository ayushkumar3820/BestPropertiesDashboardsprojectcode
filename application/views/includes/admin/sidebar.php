...
<div class="col-md-3 col-lg-2 sidebar-offcanvas bg-light pl-0" id="sidebar" role="navigation">
    ...
    <ul class="nav flex-column sticky-top pl-0 pt-5 mt-3" id="collapsingNavbar">
        ...
        if (strpos($role, 'Admin') !== false) { ?>
            ...
            <li class="nav-item"><a class="nav-link" href="<?php echo base_url('admin/projects'); ?>">Properties
                    Projects</a></li>
            ...
            <li class="nav-item"><a class="nav-link" href="<?php echo base_url('admin/meetings'); ?>">Meet ings</a></li>
