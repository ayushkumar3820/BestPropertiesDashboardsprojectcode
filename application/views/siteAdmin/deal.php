<div class="col main pt-5 mt-3">
             ...
             <a href="<?php echo base_url('admin/deal/add');?>" style="float: right;margin: 14px 2px;" class="btn btn-sm btn-info back-btn">Add New</a>
						      ...
						      if(!empty($deal)) { 
						          ...
						          foreach($deal as $deal){?>
                                       ...
                                       <td><?php echo $deal->description;?></td>
                                        <td><a href="<?php echo base_url().'admin/deal/edit/'.$deal->id;?>" class="btn btn-success btn-sm">Edit</a>
                                       <a href="<?php echo base_url().'admin/deal/delete/'.$deal->id;?>" class="btn btn-danger btn-sm">Delete</a></td>
                                      </tr>
						  <?php
						  $i++;
						      } 
