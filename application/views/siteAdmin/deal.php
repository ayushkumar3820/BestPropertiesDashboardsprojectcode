...
<div class="col main pt-5 mt-3">
    <div class="top-div">
        <div>
            <h1 class="d-sm-block heading m-0">
                <?php echo $title; ?>
            </h1>
        </div>
        <div class="top-btn-div">
            <a href="<?php echo base_url('admin/leads/add'); ?>" class="btn btn-sm btn-info back-btn">Add New</a>
            <a href="https://bestpropertiesmohali.com/admin/leads/export_page" style="float: right;margin-left: 4px;"
                class="btn btn-sm btn-success back-btn">Export</a>
        </div>
    </div>
            ...
            <div class="row1 advance-search" style="display: <?php echo $advanceSearchVisible; ?>;">
                <div class="row">
                    <div class="form-group col-sm-2">
                        ...
                        <input type="date" id="from_date" name="start_date" class="form-control"
                            value="<?php echo isset($_POST['start_date']) ? $_POST['start_date'] : ''; ?>">
                    </div>

                    <div class="form-group col-sm-2">
                        <label for="end_date">To:</label>
                        <input type="date" id="to_date" name="end_date" class="form-control"
                    ...
                    <div class="form-group col-sm-2">
                        ...
                        <input type="text" name="uName" class="form-control" placeholder="Enter Name"
                            value="<?php echo isset($_POST['uName']) ? $_POST['uName'] : ''; ?>">
                    </div>
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div id="tag-container" class="d-flex flex-wrap">
                            ...
                            <input type="text" id="tag-input" class="form-control me-2" placeholder="Add tag"
                                style="width:auto;" />
                            <button type="button" id="add-tag-btn" class="btn btn-success">Add</button>
                        </div>
                        <input type="hidden" name="leads_tags" id="leads_tags"
                            value="<?php echo isset($_POST['leads_tags']) ? htmlspecialchars($_POST['leads_tags']) : ''; ?>">
                    </div>
                    ...
                    <div class="form-group col-sm-12 align-self-end ">
                        ...
                        <button type="button" onclick="export_data()" class="btn btn-primary btn-sm"
                            ...
                            foreach ($leads as $lead) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <small>
                                            <?php echo $lead->leads_type; ?>
                                            </small? </td>
                                    <td>
                                        <?php echo $lead->mobile; ?>
                                    </td>
                                    <td>
                                        <?php echo $lead->preferred_location; ?>
                                    </td>
                                    <td>
                                        <?php
