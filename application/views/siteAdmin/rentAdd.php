...
.rent-error-msg {
    ...
    <div class="col main pt-5 mt-3">
	  ...
	  if($message != ''){
		  ...
		  //Empty the session after printing the message//
        ...
        <div class="row" id="">
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <span class="rent-error-msg rName_msg"></span>
				</div>
            </div> 
            ...
            <div class="col-sm-6">
                <div class="form-group">
					...
					<input type="text" name="address" value="" required class="form-control address" placeholder="Address">
					<span class="rent-error-msg address-msg"></span>
			...
			<div class="col-sm-6">
                <div class="form-group">
					...
					<input type="number" name="sector" value="" required class="form-control sector" placeholder="Sector">
					<span class="rent-error-msg sector-msg"></span>
				</div>
            </div>			
			...
			<div class="col-sm-6">
                <div class="form-group">
					...
					<input min="1000" type="number" id="mainRent" name="budget" required class="form-control budget" placeholder="Rent per month (in thousands)">
					<span class="rent-error-msg budget-msg"></span>
					</div>
					</div>
				</div>
            </div>            
            ...
            <div class="col-sm-6">
                <div class="form-group">
					...
					<span class="rent-error-msg property-type-msg"></span>
                </div>
            </div>
			...
			<div class="col-sm-6">
                <div class="form-group">
					...
					<span class="rent-error-msg property-status-msg"></span>
				</div>
            </div>
			...
			<div class="col-sm-6">
                <div class="form-group">
					...
					<input type="text" name="floor" value="" class="form-control sector" placeholder="Floor">
				</div>
            </div>	
	    ...
	    <div class="col-sm-12">
            ...
            <div class="col-sm-6">
                <div class="form-group">
					...
					<input type="number" name="area_in_sq_ft" value="" = class="form-control" placeholder="Area In Square Feet">
				</div>
            </div> 
...
jQuery(document).ready(function() {
      ...
      jQuery('.step-btn').click(function(){
		...
		let sector = jQuery('input.sector').val();
		...
		if(rent == '' || rent < 1000) {
		jQuery('.budget-msg').html('Rent must be at least Rs.1000.');hideShow = 'false';
		}
		if(sector == '') {
		jQuery('.sector-msg').html('Please fill out this field.');hideShow = 'false';
		}
		if(property_type == '') {
		jQuery('.property-type-msg').html('Please Select One option.');hideShow = 'false';
		}
		if(property_status == '') {
