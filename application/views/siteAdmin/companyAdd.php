...
<form class="form" method="post" action="<?php echo base_url('admin/company/add'); ?>" enctype="multipart/form-data">
		...
		<div class="row" id="">
			...
			<div class="col-sm-6">
				<div class="form-group">
					...
					<input type="text" name="company_name" value="" required class="form-control" placeholder="Company Name">
				</div>
			</div>
