                         ...
                         <thead>
						  ...
						  <tbody>
						      ...
						      if(!empty($properties)) {
						          ...
						          <tr>
						                <td><?php echo $i;?></td>
						              <!--  <td><a href="<?php echo base_url().'admin/properties/edit/'.$property->id;?>"><?php echo $property->id;?></a></td> -->
                              	...
                              	<label class="switch">
                                  <input type="checkbox" value="not approvel" <?php if($property->approvel=='approvel'){?>checked<?php }?> name="approvel" class="approvel" data-id="<?php echo $property->id;?>">
 ...
 <script>
     ...
     jQuery('.approvel').click(function(){
    ...
    if (jQuery(this).is(':checked')) {
        var approvelVal = jQuery('.approvel').val('approvel');
        var approvel = jQuery('.approvel').val();
    }  else if($(this).not(':checked'))
          {
         var approvelVal = jQuery('.approvel').val('not approvel');
         var approvel = jQuery('.approvel').val();
    }

        $.ajax({
			type: "POST",
			url: "<?php echo base_url('Siteadmin/Properties/updateApprovel');?>",
			//data:"field="+field, 
			data: {approvel: approvel,list_id:list_id},
