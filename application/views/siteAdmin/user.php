...
?>
  ...
  <div class="col main pt-5 mt-3">
             ...
             <a href="<?php echo base_url('admin/user/add');?>" style="float: right;margin: 14px 2px;" class="btn btn-sm btn-info back-btn">Add New</a>
						  ...
						  <tbody>
						      ...
						      if(!empty($users)) { 
						          ...
						          foreach($users as $user){?>
                                        <tr>
                                       <td><?php echo $i;?></td>
                                       <td><a href="<?php echo base_url().'admin/user/edit/'.$user->id;?>"><?php echo $user->fullName;?></a></td>
                                       <td><?php echo $user->email;?></td>
                                       <td><?php echo $user->phone;?></td>
                                       <td><?php echo $user->role;?></td>
                                        <td><a href="<?php echo base_url().'admin/user/edit/'.$user->id;?>" class="btn btn-success btn-sm">Edit</a>
                                       <a href="<?php echo base_url().'admin/user/delete/'.$user->id;?>" class="btn btn-danger btn-sm">Delete</a></td>
                                      </tr>
						  <?php
						  $i++;
						      } 
