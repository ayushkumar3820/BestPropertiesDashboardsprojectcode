...
?>
    ...
    <div class="col main pt-5 mt-3">
        <a href="<?php echo base_url('admin/task/') . $this->uri->segment('4'); ?>" style="float: right;margin: 14px 2px;" class="btn btn-sm btn-info back-btn">Back</a>
	  ...
	  <form class="form" method="post" action="<?php echo base_url('admin/task/edit/') . $this->uri->segment('4') . '/' . $this->uri->segment('5'); ?>" enctype="multipart/form-data">
        ...
        <div class="row" id="">
              ...
              <div class="col-sm-12">
                <div class="form-group">
					<label>Task</label>
                    <input type="text" name="task" value="<?php echo $task->task;?>" required class="form-control">				
				</div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <textarea name="task_detail" value="<?php echo $task->task_detail;?>" class="form-control" placeholder="Task Detail" rows="4"><?php echo $task->task_detail;?></textarea>
				</div>
            </div>
	  ...
	  <form class="form" method="post" action="<?php echo base_url('admin/task/edit/') . $this->uri->segment('4') . '/' . $this->uri->segment('5'); ?>">
						  ...
						  <tbody>
						      ...
						      if(!empty($comment)) { 
						          ...
						          foreach($comment as $comment){?>
                                       ...
                                       <td><a href="<?php echo base_url().'admin/task/delete-comment/'.$comment->id .'/'.$comment->comment_id;?>" class="btn btn-danger btn-sm">Delete</a></td>
                                      </tr>
						  <?php
						  $i++;
						      } 
