...
<div class="col main pt-5 mt-3">
	...
	<form class="form" method="post" action="<?php echo base_url('admin/meeting/edit/').$this->uri->segment('4').'/'.$this->uri->segment('5');?>" enctype="multipart/form-data">
		<div class="row">
			...
			<div class="col-sm-3 <?php if($type == 'status') { echo 'd-none'; } ?>" >
			...
			<div class="col-sm-3 <?php if($type == 'rechedule') { echo 'd-none'; } ?>">
				<div class="form-group">
			...
			<div class="form-group col-sm-4  <?php if($type == 'status') { echo 'd-none'; } ?>">
				<label>Purpose</label>
				<select name="purpose" class="form-control">
					...
					<?php 
						...
						foreach ($meetingPurpose as $opdtion) {
							...
							if ((isset($_POST['purpose']) && $_POST['purpose'] == $opdtion) || (!isset($_POST['purpose']) && $meeting->purpose == $opdtion)) {
								$selected = 'selected';
							}
			...
			<div class="col-sm-6 <?php if($type == 'status') { echo 'd-none'; } ?>">
				<div class="form-group">
					<label>Comment*</label>
			...
			<div class="col-sm-6 <?php if($type == 'rechedule') { echo 'd-none'; } ?>">
				<div class="form-group">
					<label>Outcome</label>
			...
			<div class="col-sm-12 <?php if($type == 'status') { echo 'd-none'; } ?>">
				<div class="form-group">
